...
session_start();
if($_POST){
    if(($_POST['usuario']=="mateo")&&($_POST['contrasenia']=="messi")){//ESTO ES PARA EL LOGIN DE ADMINISTRADOR, SI O SI TENGO QUE INGRESAR COMO NOMBRE DE USUARIO "mateo" Y CONTRASEÑA "messi" !-->
        
        $_SESSION['usuario']="ok";
        $_SESSION['nombreUsuario']=="mateo";  
